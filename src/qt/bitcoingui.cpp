...
void BitcoinGUI::createActions()
{
    ...
    multiSendAction = new QAction(QIcon(""), tr("&MultiSend"), this);
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Elite"), this);
    aboutAction->setToolTip(tr("Show information about Elite"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Elite"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Elite client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Elite client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    case 2: case 3: icon = ":/icons/connect_2"; break;
    case 4: case 5: icon = ":/icons/connect_3"; break;
    case 6: icon = ":/icons/connect_4"; break;
    case 7: case 8: case 9: icon = ":/icons/connect_5"; break;
    default: icon = ":/icons/connect_5"; break;
    }
    labelConnectionsIcon->setPixmap(QIcon(icon).pixmap(STATUSBAR_ICONSIZE,STATUSBAR_ICONSIZE));
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Elite network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Elite address or malformed URI parameters."));
    }
