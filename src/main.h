...
static const uint64_t COIN_YEAR_REWARD_OLD = 1337 * CENT; //For FORK_TIME6
static const uint64_t COIN_YEAR_REWARD = 1.337 * CENT; // 1.337% per year (Final APR). Previous APRs - 1337%, After fork1 668.5%, after fork2 334.25% and so on...
...
static const unsigned int FORK_TIME6 = 1522503420; //  Saturday 31 Mar 2018 13:37:00 GMT
